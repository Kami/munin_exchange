...
if __name__ == "__main__":
   import sys
   #sys.path.append('C:/Program Files (x86)/Zend/Zend Studio - 7.0.0/plugins/org.python.pydev.debug_1.5.4.2010011921/pysrc')

   if len(sys.argv) > 1:
	   command = sys.argv[1]

	   if settings.DEBUG and (command == "runserver" or command == "rundevserver" or command == "testserver"):
